...
const (
	NodeModule = "@google-cloud/profiler"
	NodePath   = "BPI_GOOGLE_CLOUD_PROFILER_NODE_PATH"
)
...
// https://cloud.google.com/profiler/docs/profiling-nodejs#installation
// https://cloud.google.com/profiler/docs/profiling-external#node.js
func (n NodeJSLaunch) Execute() (map[string]string, error) {
	if n.CredentialSource == common.None {
		n.Logger.Info("Google Cloud Profiler disabled")
		return nil, nil
	}
	...
	n.Logger.Infof("Google Cloud Profiler enabled (%s:%s)", s, v)
